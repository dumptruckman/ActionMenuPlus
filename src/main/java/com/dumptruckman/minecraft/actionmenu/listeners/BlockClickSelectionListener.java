...
public class BlockClickSelectionListener<V extends MenuView> extends BlockClickListener<V> {

    public BlockClickSelectionListener(@NotNull final Plugin plugin,
